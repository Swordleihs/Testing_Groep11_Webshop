...
<div id="container">
    ...
    <c:if test="${loggedIn != null}">
        <main>
            ...
            <p><a href="Controller?action=deleteProduct&productId=<c:out value="${productId}"/>" class="back">Delete</a>   <a href="Controller?action=productOverview" class="back">Cancel</a></p>
        </main>
    </c:if>
    <c:if test="${loggedIn == null}">
